...
class ProductPage(BasePage):
    ...
    def check_after_add_name_product(self):
        ...
        assert self.Product_name_before_adding == self.Product_name_after_adding, "The name of the product in the catalog and in the basket matters" # Название товара в каталоге и в корзине отличаются
    ...
    def check_price_before_and_after_add_basket(self): 
        ...
        assert price_after_click_add.text in price_before_click_add.text, "The Price of the product in the catalog and in the basket matters"
